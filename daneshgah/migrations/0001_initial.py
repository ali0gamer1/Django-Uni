    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "professor",
                    models.ManyToManyField(
                        related_name="termiccourses", to="daneshgah.professor"
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "term",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="daneshgah.term"
                    ),
                ),
                (
                    "student",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="courses", to="daneshgah.termiccourse"
            ),
        ),
        migrations.AddField(
            model_name="term",
            name="professors",
            field=models.ManyToManyField(
                related_name="asatid", to="daneshgah.professor"
            ),
        ),
        migrations.AddField(
            model_name="term",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="studentsstudying", to="daneshgah.termiccourse"
            ),
        ),
        migrations.AddField(
            model_name="student",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="daneshgah.department"
            ),
        ),
        migrations.AddField(
            model_name="student",
            name="field",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="daneshgah.field"
            ),
        ),
        migrations.AddField(
            model_name="student",
            name="passed_courses",
            field=models.ManyToManyField(
                related_name="studentswhopassed", to="daneshgah.termiccourse"
            ),
        ),
        migrations.AddField(
            model_name="student",
            name="supervisor",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="daneshgah.professor"
            ),
        ),
        migrations.CreateModel(
            name="SelectedCourse",
            fields=[
                ...
                (
                    "courses",
                    models.ManyToManyField(
                        related_name="courses2", to="daneshgah.termiccourse"
                    ),
                ),
                (
                    "student",
        ...
        migrations.AddField(
            ...
            name="taught_courses",
            field=models.ManyToManyField(
                related_name="professorsdone", to="daneshgah.abstractcourse"
            ),
        ),
        migrations.CreateModel(
            name="EmergencyDrop",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "term",
                    models.ManyToManyField(related_name="FixME", to="daneshgah.term"),
                ),
                (
                    "course",
                    models.ForeignKey(
